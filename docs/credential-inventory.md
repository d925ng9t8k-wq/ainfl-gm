...
| `POLL_MS` | triage-bridge | Daemon Config | OK | Poll interval in milliseconds for the 9↔Ara triage bridge daemon (scripts/triage-bridge.mjs). Defaults to 30000 (30s). Override to tune the self-heal trigger cadence. Not a credential. |
