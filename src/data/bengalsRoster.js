...
export const bengalsRoster = [
  ...
  { id: 7,  name: 'Kendall Milton',          position: 'RB', age: 24, capHit: 1.0,   contractYears: 3, contractTotal: 2.4,   isFranchise: false, yearsRemaining: 2, deadMoney: 0, capSavings: 1.0, baseSalary: 1.0 },
  ...
  { id: 10, name: 'Tee Higgins',             position: 'WR', age: 27, capHit: 26.5,  contractYears: 4, contractTotal: 115.0, isFranchise: false, yearsRemaining: 3, deadMoney: 21.3, capSavings: 5.3, baseSalary: 10.9 },
  { id: 11, name: 'Charlie Jones',           position: 'WR', age: 27, capHit: 1.3,   contractYears: 2, contractTotal: 2.4,   isFranchise: false, yearsRemaining: 1, deadMoney: 0.2, capSavings: 1.1, baseSalary: 1.1 },
  { id: 12, name: 'Andrei Iosivas',          position: 'WR', age: 26, capHit: 3.7,   contractYears: 3, contractTotal: 3.0,   isFranchise: false, yearsRemaining: 2, deadMoney: 0, capSavings: 3.7, baseSalary: 3.7 },
  ...
  { id: 14, name: "Ke'Shawn Williams",       position: 'WR', age: 24, capHit: 1.0,   contractYears: 2, contractTotal: 1.6,   isFranchise: false, yearsRemaining: 1, deadMoney: 0, capSavings: 1.0, baseSalary: 1.0 },
  ...
  { id: 17, name: 'Jordan Moore',            position: 'WR', age: 23, capHit: 0.9,   contractYears: 3, contractTotal: 2.4,   isFranchise: false, yearsRemaining: 2, deadMoney: 0, capSavings: 0.9, baseSalary: 0.9 },
  { id: 70, name: 'Dohnte Meyers',           position: 'WR', age: 24, capHit: 0.9,   contractYears: 2, contractTotal: 1.6,   isFranchise: false, yearsRemaining: 1, deadMoney: 0, capSavings: 0.9, baseSalary: 0.9 },
  ...
  { id: 19, name: 'Drew Sample',             position: 'TE', age: 29, capHit: 2.9,   contractYears: 2, contractTotal: 6.4,   isFranchise: false, yearsRemaining: 1, deadMoney: 0, capSavings: 2.9, baseSalary: 2.6 },
  ...
  { id: 21, name: 'Cam Grandy',              position: 'TE', age: 26, capHit: 1.1,   contractYears: 2, contractTotal: 1.8,   isFranchise: false, yearsRemaining: 1, deadMoney: 0, capSavings: 1.1, baseSalary: 1.1 },
  ...
  { id: 23, name: 'Amarius Mims',            position: 'RT', age: 23, capHit: 4.2,   contractYears: 4, contractTotal: 18.0,  isFranchise: false, yearsRemaining: 3, deadMoney: 9.1, capSavings: -4.9, baseSalary: 1.1 },
  { id: 24, name: 'Ted Karras',              position: 'C',  age: 33, capHit: 4.5,   contractYears: 2, contractTotal: 13.6,  isFranchise: false, yearsRemaining: 1, deadMoney: 0.5, capSavings: 4.0, baseSalary: 3.4 },
  { id: 25, name: 'Dylan Fairchild',         position: 'LG', age: 22, capHit: 1.5,   contractYears: 4, contractTotal: 3.6,   isFranchise: false, yearsRemaining: 3, deadMoney: 1.0, capSavings: 0.5, baseSalary: 1.1 },
  ...
  { id: 29, name: 'Javon Foster',            position: 'OT', age: 25, capHit: 1.0,   contractYears: 2, contractTotal: 1.8,   isFranchise: false, yearsRemaining: 1, deadMoney: 0, capSavings: 1.0, baseSalary: 1.0 },
  { id: 30, name: 'Andrew Coker',            position: 'OT', age: 24, capHit: 0.9,   contractYears: 2, contractTotal: 1.6,   isFranchise: false, yearsRemaining: 1, deadMoney: 0, capSavings: 0.9, baseSalary: 0.9 },
  ...
  { id: 72, name: 'Jacob Bayer',             position: 'C',  age: 24, capHit: 0.9,   contractYears: 2, contractTotal: 1.6,   isFranchise: false, yearsRemaining: 1, deadMoney: 0, capSavings: 0.9, baseSalary: 0.9 },

  // DEFENSIVE LINE — pass rushers
  { id: 32, name: 'Myles Murphy',            position: 'DE', age: 24, capHit: 4.0,   contractYears: 4, contractTotal: 16.8,  isFranchise: false, yearsRemaining: 3, deadMoney: 4.0, capSavings: 0, baseSalary: 2.5 },
  ...
  { id: 34, name: 'Shemar Stewart',          position: 'DE', age: 22, capHit: 4.3,   contractYears: 4, contractTotal: 11.2,  isFranchise: false, yearsRemaining: 3, deadMoney: 15.5, capSavings: -11.2, baseSalary: 1.0 },
  { id: 35, name: 'Isaiah Foskey',           position: 'DE', age: 25, capHit: 1.1,   contractYears: 2, contractTotal: 3.6,   isFranchise: false, yearsRemaining: 1, deadMoney: 0, capSavings: 1.1, baseSalary: 1.1 },
  { id: 36, name: 'Cedric Johnson',          position: 'DE', age: 23, capHit: 1.1,   contractYears: 3, contractTotal: 2.7,   isFranchise: false, yearsRemaining: 2, deadMoney: 0.1, capSavings: 1.0, baseSalary: 1.1 },
  ...
  { id: 41, name: 'Kris Jenkins Jr.',        position: 'DT', age: 24, capHit: 2.1,   contractYears: 4, contractTotal: 11.6,  isFranchise: false, yearsRemaining: 3, deadMoney: 2.3, capSavings: -0.1, baseSalary: 1.5 },
  { id: 42, name: 'McKinnley Jackson',       position: 'DT', age: 24, capHit: 1.5,   contractYears: 3, contractTotal: 4.5,   isFranchise: false, yearsRemaining: 2, deadMoney: 0.4, capSavings: 1.1, baseSalary: 1.3 },
  ...
  { id: 47, name: 'Barrett Carter',          position: 'LB', age: 23, capHit: 1.3,   contractYears: 4, contractTotal: 4.8,   isFranchise: false, yearsRemaining: 3, deadMoney: 0.7, capSavings: 0.5, baseSalary: 1.0 },
  ...
  { id: 49, name: 'Liam Anderson',           position: 'LB', age: 25, capHit: 1.0,   contractYears: 2, contractTotal: 1.8,   isFranchise: false, yearsRemaining: 1, deadMoney: 0, capSavings: 1.0, baseSalary: 1.0 },
  { id: 50, name: 'Shaka Heyward',           position: 'LB', age: 25, capHit: 1.1,   contractYears: 2, contractTotal: 1.8,   isFranchise: false, yearsRemaining: 1, deadMoney: 0, capSavings: 1.1, baseSalary: 1.1 },
  ...
  { id: 54, name: 'Josh Newton',             position: 'CB', age: 25, capHit: 1.2,   contractYears: 3, contractTotal: 3.0,   isFranchise: false, yearsRemaining: 2, deadMoney: 0.2, capSavings: 1.0, baseSalary: 1.1 },
  ...
  { id: 56, name: 'D.J. Ivey',               position: 'CB', age: 26, capHit: 1.2,   contractYears: 2, contractTotal: 1.8,   isFranchise: false, yearsRemaining: 1, deadMoney: 0, capSavings: 1.2, baseSalary: 1.1 },
  { id: 57, name: 'Jalen Kimber',            position: 'CB', age: 25, capHit: 0.9,   contractYears: 2, contractTotal: 1.6,   isFranchise: false, yearsRemaining: 1, deadMoney: 0, capSavings: 0.9, baseSalary: 0.9 },
  { id: 58, name: 'Bralyn Lux',              position: 'CB', age: 25, capHit: 0.9,   contractYears: 3, contractTotal: 2.4,   isFranchise: false, yearsRemaining: 2, deadMoney: 0, capSavings: 0.9, baseSalary: 0.9 },
  ...
  { id: 60, name: 'Jordan Battle',           position: 'S',  age: 25, capHit: 3.9,   contractYears: 3, contractTotal: 3.6,   isFranchise: false, yearsRemaining: 2, deadMoney: 0.2, capSavings: 3.7, baseSalary: 3.7 },
  ...
  // SPECIAL TEAMS
  { id: 66, name: 'Evan McPherson',          position: 'K',  age: 26, capHit: 5.0,   contractYears: 3, contractTotal: 13.5,  isFranchise: false, yearsRemaining: 2, deadMoney: 4.2, capSavings: 0.8, baseSalary: 2.8 },
  { id: 67, name: 'Ryan Rehkow',             position: 'P',  age: 27, capHit: 1.1,   contractYears: 3, contractTotal: 3.6,   isFranchise: false, yearsRemaining: 2, deadMoney: 0, capSavings: 1.1, baseSalary: 1.1 },
