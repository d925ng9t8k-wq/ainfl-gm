...
export const mlbFreeAgents = [
  ...
  { id:'FA-SP-5', name:'Sean Manaea',          position:'SP', age:33, salary:12.0, contractYears:1, serviceTime:8,  rating:78, notes:'NYM walk year' },
  { id:'FA-SP-6', name:'Luis Severino',        position:'SP', age:31, salary:12.0, contractYears:1, serviceTime:9,  rating:76, notes:'NYM walk year' },
  { id:'FA-SP-7', name:'Jordan Montgomery',    position:'SP', age:32, salary:20.0, contractYears:3, serviceTime:8,  rating:78, notes:'ARI — seeking extension' },
  { id:'FA-SP-8', name:'Nathan Eovaldi',       position:'SP', age:35, salary:14.0, contractYears:1, serviceTime:12, rating:79, notes:'TEX walk year' },

  // ─── SOLID STARTERS ─────────────────────────────────────────────────────────
  { id:'FA-SP-9', name:'Marcus Stroman',       position:'SP', age:34, salary:12.0, contractYears:1, serviceTime:10, rating:75, notes:'NYY — ground ball machine' },
  { id:'FA-SP-10',name:'Jon Gray',             position:'SP', age:33, salary:10.0, contractYears:1, serviceTime:10, rating:75, notes:'TEX walk year' },
  { id:'FA-SP-11',name:'Andrew Heaney',        position:'SP', age:34, salary:7.0,  contractYears:1, serviceTime:10, rating:72, notes:'TEX walk year' },
  { id:'FA-SP-12',name:'Wade Miley',           position:'SP', age:38, salary:4.0,  contractYears:1, serviceTime:13, rating:67, notes:'Veteran innings-eater' },
  { id:'FA-SP-13',name:'Charlie Morton',       position:'SP', age:41, salary:5.0,  contractYears:1, serviceTime:17, rating:70, notes:'Veteran presence' },
